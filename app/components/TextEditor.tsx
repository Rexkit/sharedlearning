...
const TextEditor = ({ previewMode = false, page_id, contentData }: editorProps) => {
    ...
    return (
        <div className="container px-5 mx-auto pb-5">
            {editorState && <DanteEditor widgets={[]} readOnly={previewMode} content={editorState} onUpdate={onContentChange} />}
            {!previewMode &&
